...
public class AddCandidatForm extends Form {
  ...
  private Image img;
    ...
    public AddCandidatForm(Casting ca) {
        ...
        TextField firstName = new TextField("ffgghjk", "nomC");
        TextField cin = new TextField("", "12345678", 8, TextArea.NUMERIC);
        ...
        ComboBox idcasting = new ComboBox("", castings);
     ...
     uploadImage.addActionListener(new ActionListener(){
        ...
        btn.addActionListener((evt) -> {
            if ((firstName.getText().length() == 0) || (cin.getText().length() == 0) 
                    || (motivation.getText().length() == 0) || (email.getText().length() == 0) || (phone.getText().length() == 0)) {
                Dialog.show("Alert", "Please fill all the fields", "OK", null);
            } else {
                try {
                   Casting  casting = new  Casting((int)idcasting.getSelectedItem()) ;
                    Candidat candidat = new Candidat(firstName.getText(),casting, Integer.parseInt(cin.getText()), cv, motivation.getText(), email.getText(),
        ...
        this.addAll(firstName, cin, uploadImage, motivation, email, phone, idcasting, btn);
