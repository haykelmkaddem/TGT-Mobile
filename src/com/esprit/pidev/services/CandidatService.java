...
int identretient = result.getAsInteger("identretient/id");
...
Casting casting = new Casting(idcasting);
Entretien entretient = new Entretien(identretient);            
                candidat.add(new Candidat(id,casting,entretient, nomC, cinCondidat, cv, motivation, mailaddress, tel));
            }
    ...
    public boolean addCandidat(Candidat candidat) {
        ...
        System.out.println(candidat);
         ...
         String url = Statics.BASE_URL + "/candidat/new" + "?nomC=" + candidat.getNomC() + "&cinCondidat=" +candidat.getCinCondidat()
                + "&cv=" +candidat.getCv()+"&motivation=" +candidat.getMotivation()+
                 "&mailaddress=" +candidat.getMailaddress()+"&tel=" +candidat.getTel()+"&id_casting="+candidat.getCasting().getId() ;
